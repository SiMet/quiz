...
public class QuestionDataSource {
    ...
    private String[] allColumns = { QuestionSQLite.COLUMN_ID, QuestionSQLite.COLUMN_CONTENT };
    ...
    public Question createQuestion(Question question) {
        ...
        values.put(QuestionSQLite.COLUMN_CONTENT, question.getContent());
        long insertId = database.insert(QuestionSQLite.TABLE_NAME, null, values);
        for(Answer answer : question.getAnswers()){
            answerDataSource.createAnswer(answer, insertId);
        }
        Cursor cursor = database.query(QuestionSQLite.TABLE_NAME, allColumns, QuestionSQLite.COLUMN_ID + " = " + insertId, null, null, null, null);
        cursor.moveToFirst();
    ...
    public List<Question> findAll() {
        ...
        Cursor cursor = database.query(QuestionSQLite.TABLE_NAME, allColumns, null, null, null, null, null);
